...
private:
	...
	//	If progressive then continue rendering the next frame
	bool isProgressive;
...
public:
	 ...
	 * The constructor.
	 */
	Renderer(std::shared_ptr<Scene> scene, bool isProgressive = false );
	...
	// Some getters
	std::string getOutputFilename() { return this->outputFilename; }
	int getWidth() { return this->width; }
	int getHeight() { return this->height; }
	int getNumFrames() { return this->numFrames; }
	int getCurrentFrame() { return this->currentFrame; }
	optix::Buffer& getResultBuffer() { return this->resultBuffer; }
};